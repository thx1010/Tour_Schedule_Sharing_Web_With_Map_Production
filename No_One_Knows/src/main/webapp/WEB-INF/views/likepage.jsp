        ...
        <header style="background: linear-gradient( to bottom, white, rgba( 182, 222, 255, 0.1 ) );">
	        <div class="container">
		        <section class="container" style="margin-top: 10px;">
		            ...
		            <h2 style=" text-align:center; margin-bottom: 60px;">당신의 찜 목록입니다</h2>
				...
				<div class="tscale"><a href = "#" style="text-decoration:none"><button style="background: linear-gradient( to left, #FAED7D, #FFCD12 ); color:white; border-radius: 15%; display: block; margin-top: 10px auto; "><h5><img src = "resources/img/check.png" style="width: 20px; height:20px;">&nbsp;장바구니에 담기</h5></button></a></div>
				</div>
			</div>
	        </div>
	    </header>
